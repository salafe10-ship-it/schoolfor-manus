...
const EnterpriseProcurementQualityAudit = lazyWithChunkRecovery(() => import('./certification/EnterpriseProcurementQualityAudit'));
...
const EnterpriseCoreCertificationDashboard = lazyWithChunkRecovery(() => import('./certification/EnterpriseCoreCertificationDashboard'));
const EnterpriseBusinessLogicAudit = lazyWithChunkRecovery(() => import('./certification/EnterpriseBusinessLogicAudit'));
const AccountingIntegrityCertification = lazyWithChunkRecovery(() => import('./certification/AccountingIntegrityCertification'));
const EnterpriseSecurityPermissionsCert = lazyWithChunkRecovery(() => import('./certification/EnterpriseSecurityPermissionsCert'));
const EnterpriseUIUXGoldenStandardCert = lazyWithChunkRecovery(() => import('./certification/EnterpriseUIUXGoldenStandardCert'));
const EnterprisePerformanceStabilityCertification = lazyWithChunkRecovery(() => import('./certification/EnterprisePerformanceStabilityCertification'));
const EnterpriseMaintainabilityScalabilityCertification = lazyWithChunkRecovery(() => import('./certification/EnterpriseMaintainabilityScalabilityCertification'));
const EnterpriseZeroRegressionCert = lazyWithChunkRecovery(() => import('./certification/EnterpriseZeroRegressionCert'));
const EnterpriseProductionReadinessGate = lazyWithChunkRecovery(() => import('./certification/EnterpriseProductionReadinessGate'));
const EnterpriseDocumentationHardening = lazyWithChunkRecovery(() => import('./certification/EnterpriseDocumentationHardening'));
const EnterpriseWave1FinalCertification = lazyWithChunkRecovery(() => import('./certification/EnterpriseWave1FinalCertification'));
const EnterpriseCommercialReleaseQualityCertification = lazyWithChunkRecovery(() => import('./certification/EnterpriseCommercialReleaseQualityCertification'));
const EnterpriseCommercialCompetitivenessCertification = lazyWithChunkRecovery(() => import('./certification/EnterpriseCommercialCompetitivenessCertification'));
const EnterpriseProductMaturityCertification = lazyWithChunkRecovery(() => import('./certification/EnterpriseProductMaturityCertification'));
const EnterpriseCoreSystemCertification = lazyWithChunkRecovery(() => import('./certification/EnterpriseCoreSystemCertification'));
const EnterpriseOperationalExcellenceCertification = lazyWithChunkRecovery(() => import('./certification/EnterpriseOperationalExcellenceCertification'));
const EnterpriseUserTrustCertification = lazyWithChunkRecovery(() => import('./certification/EnterpriseUserTrustCertification'));
const EnterpriseGoldenReleaseExecutionProgram = lazyWithChunkRecovery(() => import('./certification/EnterpriseGoldenReleaseExecutionProgram'));
const EnterpriseDDDReconstruction = lazyWithChunkRecovery(() => import('./certification/EnterpriseDDDReconstruction'));
const SystemSettingsPortal = lazyWithChunkRecovery(() => import('./components/SystemSettingsPortal'));
import { 
  branchesSeed, 
  teachersSeed, 
  initialAttendance, 
      ...
      try {
        ...
        setSelectedSchool((current) => current.id === workspace.schoolId
          ? {
              ...
              templateManifest: workspace.templateManifest && typeof workspace.templateManifest === 'object' ? workspace.templateManifest : current.templateManifest,
            }
          : current);
