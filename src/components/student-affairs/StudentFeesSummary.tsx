    ...
    <div className="space-y-4 text-right" id="student-fees-summary-section">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="p-4 text-right">
          ...
          <p className="text-lg font-black text-slate-500 mt-1">غير متوفر</p>
          <span className="bg-gradient-to-r from-[#2a1d13] via-[#3a2719] to-[#2a1d13] text-amber-200 font-extrabold">بانتظار تفاصيل الفواتير المركزية</span>
        </div>

        <div className="p-4 text-right">
          <p className="text-[10px] text-slate-400 font-bold">إجمالي المبالغ المسددة</p>
          <p className="text-lg font-black text-slate-500 mt-1">غير متوفر</p>
          <span className="inline-block bg-slate-50 text-slate-600 text-[8.5px] px-1.5 py-0.2 rounded font-black mt-2">لا توجد مدفوعات موثقة</span>
        </div>
      ...
      <div className="overflow-hidden shadow-sm">
        <div className="bg-transparent p-4 border-b border-slate-200 flex justify-between items-center flex-row-reverse">
          ...
          <span className="text-[10px] bg-amber-50 text-amber-700 border border-amber-200 font-black px-2 py-0.5 rounded-lg">
            حالة الحساب المالي: {formStudent.feesRemaining > 0 ? 'متبقي حسب الرصيد المركزي' : 'غير متحقق لغياب تفاصيل الفواتير'}
          </span>
        </div>
