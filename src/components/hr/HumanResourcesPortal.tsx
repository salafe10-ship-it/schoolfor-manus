...
export default function HumanResourcesPortal({ setActiveSection, selectedSchool, canUseTrustedPermission = (permission) => permission === PERMISSIONS.HR_WRITE ? canManage : permission === PERMISSIONS.HR_APPROVE ? canApprove : permission === PERMISSIONS.FINANCIAL_WRITE ? canFinancialWrite : false, canManage = false, canApprove = false, canFinancialWrite = false }: HumanResourcesPortalProps) {
  ...
  const [settings, setSettings] = useState<HRSettings>({
    ...
    defaultBankSafeAccount: '1101',
    bankAccount: '1102',
    defaultSalariesExpenseAccount: '5110',
    payrollPayableAccount: '',
    advanceReceivableAccount: '',
    deductionClearingAccount: '',
    payrollBasicSalaryAccount: '5110',
    payrollAllowancesAccount: '5111',
    medicalAllowanceAccount: '5112',
    payrollBonusesAccount: '5113',
    payrollOvertimeAccount: '5114',
    shortTermAdvanceAccount: '1220',
    longTermAdvanceAccount: '1221',
    endOfServiceExpenseAccount: '5115',
