...
export default function EnterpriseActionToolbar({
  ...
  const subtitleMap: Record<string, string> = {
    ...
    'إدارة الزي المدرسي': 'الأصناف والمقاسات والقياسات والتوريد والصرف والمرتجعات المرتبطة بالطلاب',
    'إدارة النقل والترحيل المدرسي': 'إدارة الأسطول والمسارات واشتراكات الطلاب والسلامة التشغيلية',
