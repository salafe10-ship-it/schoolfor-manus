                    ...
                    <tr>
                     ...
                     <tr>
                       <td colSpan={7} className="p-8 text-center font-bold">
                         {studentLoadError ? (
                           <div role="alert" className="flex flex-col items-center gap-3 text-rose-800">
                             <span>{studentLoadError}</span>
                             <button
                               type="button"
                               onClick={() => setStudentRefreshToken(value => value + 1)}
                               className="inline-flex items-center gap-2 rounded-xl border border-rose-300 bg-rose-50 px-4 py-2 text-xs font-black text-rose-900 transition hover:bg-rose-100"
                             >
