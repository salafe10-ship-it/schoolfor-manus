...
-- Phase 1 only: schema definition. This file is not executed by this change.
...
-- Rollback strategy: remove platform objects in reverse dependency order only
-- through a separately reviewed rollback migration. Tenant RBAC is untouched.
